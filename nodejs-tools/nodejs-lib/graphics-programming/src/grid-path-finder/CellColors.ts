...
export function getCellColor(
  ...
  if (game.getCurrentPointerCellId() === cell.id) {
    return gridPathFinderCellColors.currentPointer;
  }
  if (game.isCellPartOfSolutionPath(cell)) {
    return gridPathFinderCellColors.belongsToShortedPath;
  }
