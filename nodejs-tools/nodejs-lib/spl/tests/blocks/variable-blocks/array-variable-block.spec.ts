...
describe('check functionality of variable block', () => {
  ...
  test('should declare an array variable in scope when ' + 'executed on a declaration VariableBlock', () => {
  ...
  test('should modify variable in scope when ' + 'executed on a set ArrayVariableBlock', () => {
    // Declaration
    variableBlock.execute();
