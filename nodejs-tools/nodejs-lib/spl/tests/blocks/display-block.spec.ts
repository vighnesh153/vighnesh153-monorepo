...
describe('check functionality of display block.', () => {
  ...
  test('should add newline character to output ' + 'buffer if input values array is empty.', () => {
    const values: string[] = [];
  ...
  test('should add numbers to the output ' + 'buffer if numbers are passed as values array.', () => {
  ...
  test('should add booleans to the output ' + 'buffer if booleans are passed as values array.', () => {
  ...
  test('should add strings to the output ' + 'buffer if strings are passed as values array.', () => {
  ...
  test('should add value of number variable to the output buffer.', () => {
    ...
    const variableBlock = new VariableBlock(VariableBlockType.declare, 'someVariable', 'number', 4200, true, scope);
  ...
  test('should add value of boolean variable to the output buffer.', () => {
    const values: string[] = ['someVariable'];
    const scope = new Scope();
    const variableBlock = new VariableBlock(VariableBlockType.declare, 'someVariable', 'boolean', false, true, scope);
    variableBlock.execute();
    const displayBlock: Block = new DisplayBlock(values, scope);
    displayBlock.execute();
  ...
  test('should add mixed datatype values along with ' + 'variable values to the output buffer.', () => {
    const scope = new Scope();
    const variableBlock = new VariableBlock(VariableBlockType.declare, 'iAmAVariable', 'string', 'LoL', true, scope);
    variableBlock.execute();
