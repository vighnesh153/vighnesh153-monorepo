...
!function (t, o) {
  ...
  function i(t, o) {
    return o.offset[t]
      ? isNaN(o.offset[t]) ? o.offset[t] : o.offset[t] + "px"
      : "0px";
  }
  function s(t, o) {
    ...
    o.lib = o.prototype = {
      ...
      init: function (t) {
        return t || (t = {}),
          ...
          this.options.duration = 0 === t.duration
            ? 0
          ...
          this.options.gravity = "bottom" === t.gravity
            ? "toastify-bottom"
            : o.defaults.gravity,
      ...
      buildToast: function () {
        ...
        for (
          var o in t.className = "toastify on " + this.options.className,
        ...
        if (!0 === this.options.close) {
          ...
          ("left" == this.options.position ||
              !0 === this.options.positionLeft) && n > 360
      ...
      showToast: function () {
        ...
        if (
          this.toastElement = this.buildToast(),
            !(t = "string" == typeof this.options.selector
      ...
      removeElement: function (t) {
        t.className = t.className.replace(" on", ""),
          window.setTimeout(
            function () {
              this.options.node && this.options.node.parentNode &&
