...
<p class="-mt-6 italic text-center text-text2">(Use your mouse to move particles)</p>
<canvas class="mt-4 mx-auto w-full max-w-3xl aspect-video bg-text" bind:this={canvasElement} on:mousemove={onMouseMove}>
