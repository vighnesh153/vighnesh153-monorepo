...
export const UPPERCASE_ALPHABET = LOWERCASE_ALPHABET.toUpperCase() as Uppercase<typeof LOWERCASE_ALPHABET>;

export const ALPHABET = (LOWERCASE_ALPHABET +
  UPPERCASE_ALPHABET) as `${typeof LOWERCASE_ALPHABET}${Uppercase<typeof LOWERCASE_ALPHABET>}`;
