...
- **Application** refers to Disable alt/option + Click shortcut, the software program provided by the Company.

- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Disable alt/option + Click shortcut.
