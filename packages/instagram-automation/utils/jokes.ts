export const jokes = [
  ...
  {
    type: 'general',
    setup: `If you're American when you go into the bathroom, and American when you come out, 
      what are you when you're in there?`,
    punchline: 'European',
  },
  {
    type: 'general',
  ...
  },
  {
    type: 'general',
    setup:
      `A weasel walks into a bar. The bartender says, Wow, I've never served a weasel ` +
      `before. What can I get for you?`,
