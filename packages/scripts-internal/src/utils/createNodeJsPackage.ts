 ...
 */
export async function createNodeJsPackage(directoryPath: string, packageName: string) {
  ...
  if (await fileExists(directoryPath)) {
    ...
    throw new Error(`"${parentDirectoryName}/${currentDirectoryName}" already exists...`);
  }
