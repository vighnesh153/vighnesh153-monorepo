...
import { publicFilesMetadataTableSingletonFactory } from "../common/factories/dynamodb_factories";
...
export const handler: Handler<S3Event> = async (request) =>
  s3BucketEventListener({
    ...
    filesMetadataDynamoTable: publicFilesMetadataTableSingletonFactory(),
  });
