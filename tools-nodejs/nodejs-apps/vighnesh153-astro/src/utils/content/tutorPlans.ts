...
export const mathTutorPlans: TutorPlanProps[] = [
  {
    ...
    description:
      "Master the art of counting with permutations and combinations in this comprehensive course",
    price: 8_000,
    isPopular: true,
    tags: ["beginner"],
    prerequisites: [],
  ...
  },
  {
    name: "Algebra",
    description:
      "Master the essential concepts of trigonometry with this comprehensive course",
    price: 12_000,
    isPopular: false,
    tags: ["beginner"],
    prerequisites: [],
  ...
  },
  {
    name: "Calculus",
    description:
      "Master the essential concepts of calculus with this comprehensive course",
    price: 12_000,
    isPopular: true,
    tags: ["beginner"],
    prerequisites: [],
...
export const codingTutorPlans: TutorPlanProps[] = [
  ...
  },
  {
    ...
    description:
      "Learn to create your own website with this beginner-friendly course.",
    price: 12_000,
    isPopular: false,
    tags: ["beginner"],
    prerequisites: [],
  ...
  },
  {
    ...
    description:
      "Learn to create your simpel games with this beginner-friendly course.",
    price: 15_000,
    isPopular: false,
    tags: ["intermediate"],
  ...
  },
  {
    ...
    description:
      "Master the essential concepts of data structures and algorithms with this comprehensive course",
    price: 20_000,
    isPopular: true,
    tags: ["intermediate"],
  ...
  },
  {
    ...
    description:
      "Master the skills you need to build beautiful and responsive websites with this comprehensive course",
    price: 18_000,
    isPopular: false,
    tags: ["beginner"],
    prerequisites: [],
