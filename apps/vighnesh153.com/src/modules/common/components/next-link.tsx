// Cloned from https://github.com/mui/material-ui/blob/master/examples/nextjs-with-typescript/src/Link.tsx
...
const NextLinkComposed = React.forwardRef<HTMLAnchorElement, NextLinkComposedProps>((props, ref) => {
...
export const MuiNextLink = React.forwardRef<HTMLAnchorElement, MuiNextLinkProps>((props, ref) => {
  const {
